...
- [技术总结与算法研究](#技术总结与算法研究)
  ...
  - [1 基础算法与技术](#1-基础算法与技术)
    ...
    - [1.2 深度学习](#12-深度学习)
    - [1.3 CNN](#13-cnn)
    - [1.4 Transformer](#14-transformer)
    - [1.5 GAN](#15-gan)
    - [1.6 强化学习](#16-强化学习)
  - [2 目标检测](#2-目标检测)
  ...
  - [7 量化、部署与推理](#7-量化部署与推理)
    ...
    - [7.3 瑞芯微Rockchip RKNN](#73-瑞芯微rockchip-rknn)
...
目标跟踪(Object Tracking)算法主要用于在视频或连续帧图像中跟踪目标的位置和状态。包括：

- **传统算法** : 卡尔曼滤波、相关滤波算法等
- **深度学习** : 目标检测+数据关联、孪生网络、Transformer、端到端DERT
- **多目标跟踪** : ReID、OSNet等
- **红外目标跟踪** : 滤波算法等
...
图像分割(Image Segmentation)是计算机视觉中的一个重要任务，主要用于将图像划分为多个区域，每个区域对应不同的物体或背景。根据输出的不同，图像分割可以分为以下几类：

- **语义分割(Semantic Segmentation)** : 将图像中的每个像素分类为某个类别(如天空、道路、汽车等); FCN、U-Net、DeepLab。
...
<<<<<<< HEAD
### 8.1 [Python](/doc/QA/python/README.md)

在这篇文档中，我记录了在使用 Python 编程过程中遇到的一些问题及其解决方法。

### 8.2 [Cpp](/doc/QA/cpp/README.md)
...
>>>>>>> ed7336253e40a0182794ed5c3e8fdff3b6f3b229
